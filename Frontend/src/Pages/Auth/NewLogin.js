...
export default function LoginNew() {
 ...
 const HandlePhoneLogin = (e) => {
  ...
  return (
    ...
    <div>
    {msg&&<div className='animate-[fadeInDown_2s] z-10 top-0 fixed w-full'>
...
<section class="bg-white">
  ...
  {/* <div class="lg:grid lg:min-h-screen lg:grid-cols-12"> */}
   ...
   <div class="hidden lg:relative lg:block  lg:t-0 ">
        ...
        <h2 class="font-lexend  text-2xl font-bold text-black sm:text-3xl md:text-3xl  ">
          Welcome Back to Essentia
        </h2>

        <p class="mt-2 leading-relaxed  text-black/90 font-light font-lexend">
        Step into Essentia - Where Homes Find Harmony
        </p>
      </div>
...
<div className="flex flex-col  items-center justify-center space-y-5  mt-4 ">
  {/* <div className=""> */}
    ...
    >
       {loading ? (
                    <CgSpinnerTwo size={22} className=" animate-spin items-center justify-center w-full" />
                  ):
                 ( <>Login</>)
