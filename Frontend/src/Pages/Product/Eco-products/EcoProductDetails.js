...
export default function EcoProductDetails() {
    const { id } = useParams();
        ...
        <div class="max-w-6xl px-4 py-4 mx-auto md:px-0 md:py-0">
            <div class="flex flex-wrap -mx-4">
                        ...
                        <div class="flex-wrap hidden md:flex ">
                            ...
                            <div class="w-1/2 p-2 sm:w-1/4">
                                <button  onClick={()=>{setImage(image)}}    
                                    class="block border border-green-500 border-2dark:border-transparent   hover:border-green-300">
                ...
                <div class="w-full px-4 md:w-1/2 md:px-0">
                    <div class="lg:pl-20">
                        <div class="mb-0 ">
                            <span class="text-lg font-medium text-green-600 dark:text-rose-200">{product.brand}</span>
                            ...
                            <h2 class="max-w-xl mt-2 mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">
                                ...
                                <div className=" -mt-4 ">
                                                            ...
                                                            <img className='hover:bg-green-100 rounded-full  p-1' src="https://www.jiomart.com/assets/ds2web/jds-icons/share-desktop-icon.svg" alt=""/>
                                                            </span>
                                                            </a>
                                </div>
                                {/* shareicon */}
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor"
                                                class="w-4 mr-1 text-green-500 dark:text-gray-400 bi bi-star "
                                                viewBox="0 0 16 16">
                                                <path
                        ...
                        <div class="flex flex-wrap items-center -mx-4 ">
                            <div class="w-full px-4 mb-4 lg:w-1/2 lg:mb-0">
                                <button onClick={()=>handleAddToCart(product)} 
                                    class="flex items-center justify-center w-full p-4 text-green-500 border border-green-500 rounded-md dark:text-gray-200 dark:border-green-500 hover:bg-green-500 hover:border-green-600 hover:text-gray-100 dark:bg-green-600 dark:hover:bg-green-500 dark:hover:border-green-500 dark:hover:text-gray-300">
                                    Add to Cart
                                </button>
                            </div>
                            <div class="w-full px-4 mb-4 lg:mb-0 lg:w-1/2">
                                <button onClick={()=>addToWishList(product)}
                                    class="flex items-center justify-center w-full p-4 text-pink-500 border border-pink-500 rounded-md dark:text-gray-200 dark:border-green-500 hover:bg-pink-500 hover:border-pink-600 hover:text-gray-100 dark:bg-green-600 dark:hover:bg-green-500 dark:hover:border-green-500 dark:hover:text-gray-300">
                                    Add to wishlist
                                </button>
                            </div>
                        </div>
...
{/* //line */}
    ...
    {[1,2,3,4,5].map((rating, index) => (
      <div className="flex items-center mt-4" key={rating}>
        ...
        <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
          <div
            className="h-5 bg-green-300 rounded"
          ...
          {starPercentages[index]}%
                                ...
                                <div className='flex'>
                                    ...
                                    <svg onClick={openReviewModal}
                                        key={value}
                                        className={`star-svg ${rating >= value ? 'fill-green-400' : ''}`}
                                        stroke="currentColor"
                                        fill='gray'
                                        strokeWidth="0"
                                        viewBox="0 0 24 24"
 ...
 {/* //customer reviews      */}
    <div className="w-full px-4 md:w-1/2">
              ...
              const month = String(reviewDate.getMonth() + 1).padStart(2, '0'); // Months are 0-indexed
              ...
              return (
                <div className='bg-gray-200 px-2 pt-1 rounded-md' key={review.reviewRatingId}>
                  <div className="">
                    <span className="flex justify-between">
                      <span className="flex space-x-3 mb-3">
                        ...
                        <span className="-space-y-1">
                          ...
                          <p className="text-xs text-gray-500">{formattedDate}</p> {/* Use formatted date */}
                        </span>
                      </span>
                      <span className="flex">
                        <span>
                        ...
                        <span className="flex flex-row">
                          {[1, 2, 3, 4, 5].map((value) => (
                            <svg
                              key={value}
                              className={`star-svg ${
                                review.rating >= value ? 'fill-green-400' : ''
                              }`}
                              stroke="currentColor"
                              fill="gray"
                              strokeWidth="0"
