...
import { Link } from 'react-router-dom';
 ...
 const ProductCards =({ product }) =>{
  ...
  <Link to={`/product/${product.productId}`}>
      ...
      alt=""
      class=" absolute inset-0 h-56 w-full object-fill opacity-100 group-hover:opacity-0"
    />
    <img
      src={product.imageURL[1]}
      alt=""
      class="   inset-0 h-56 w-full object-fill opacity-0 group-hover:opacity-100"
