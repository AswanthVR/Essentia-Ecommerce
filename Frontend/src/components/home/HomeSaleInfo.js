  ...
  return (
    <div className="relative h-[580px] ">
      ...
      border-gray-600   border-l-8 border-t-8  shadow-gray-400  shadow-md">
        ...
        <Link to={'/product/All-products'} >     <button className="bg-yellow-600 brightness-150 py-3 px-8 flex flex-row item-center ml-[150px]   items-center justify-center hover:translate-x-1.5  hover:scale-105 duration-500">
          SHOP NOW
