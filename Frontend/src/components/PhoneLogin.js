...
const PhoneLogin = ({ userData }) => {
  ...
  return (
    ...
    <section className="h-500 w-400 bg-gray-200 p-[10%] rounded-xl ">
     
     <span className='text-yellow-500 justify-end flex curs'>
       <button onClick={()=>{checkLogin()}} className='underline font-light text-xs '>SKIP ></button>
      </span>
      {/* <div> */}
