...
const [categories, setCategories] = useState([]);
  ...
  const fetchSubCategories = (categoryId) => {
    axios.get(`http://localhost:8080/subcategory/getByCategoryId/${categoryId}`, {
      headers: {
  ...
  const handleCategoryChange = (e) => {
    ...
    fetchSubCategories(categoryId); // Fetch subcategories here
    handleChange(e);
  };
  ...
  return (
    ...
    <Sidebar/>
    {/* <DefaultSidebar /> */}
    <div className=" flex-grow w-full ml-[20%] mr-10"> 
    <div>
...
<div className=" w-full mx-auto mt-10 p-6 bg-white rounded shadow-lg">
  ...
  <form onSubmit={handleSubmit}>
    <div className='grid md:grid-cols-2 grid-cols-1 md:space-x-20 h-full'>
    <div>
    <div className="mb-4">
    ...
    <div className="mb-4">
  <label className="block text-gray-700 font-bold mb-2">Product Subcategory:</label>
  <select
    className="border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
