...
<span class="px-3.5 py-2 text-white bg-yellow-500 group-hover:bg-yellow-600 flex items-center justify-center">
{/* <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg> */}
<img className='text-rose-500 fill-rose-500' width="24" height="24" src="https://img.icons8.com/material-outlined/24/like--v1.png" alt="like--v1"/></span>
          ...
          <div className="rounded-lg md:w-2/3">
            {cartData.map((item) => (
              ...
              >
                ...
                />
                <div className="sm:ml-4 md:flex sm:w-full sm:justify-between">
                  ...
                  <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                    <div className="flex items-center border-gray-100">
                      ...
                      <p className="px-2.5 py-[6.5px] border bg-white text-center text-xs justify-center items-center">
  {item.quantity}
</p>
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            ...
            className="mt-6 w-full rounded-md bg-yellow-500 py-1.5 font-medium text-yellow-50 hover:bg-yellow-600">
              Check out
            </button></Link>
          </div>
          </div>
