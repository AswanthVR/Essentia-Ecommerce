...
const Token = getToken('token');
  ...
  const [eco, setEco] = useState("normal");
  ...
  const toggleEco = () => {
    setEco("normal");
    localStorage.setItem("eco","normal") 
  }

  const handleNav = () => { 
        setEco("eco");
        localStorage.setItem("eco","eco")
        console.log(localStorage.getItem("eco"));
        navigate('/product/All-products/eco-products');
  }

    // useEffect(() => {
    //     // You can use local storage or any other method to persist the theme preference across sessions
    //     localStorage.setItem("darkMode", JSON.stringify(darkMode));
    //     // Apply dark mode styles or toggle classes here
    //     if (darkMode) {
    ...
    // }, [darkMode]);
    return (
        <div className=" bg-gray-900 top-0 sticky  z-10 w-full">
            <div>
                <div className="  bg-gray-800">
                    {/* For md screen size */}
                    {/* <div id="md-searchbar" className={`${mdOptionsToggle ? "hidden" : "flex"} bg-white  bg-gray-900 lg:hidden py-5 px-6 items-center justify-between`}>
                        <div className="flex items-center space-x-3 text-gray-800  text-white">
                            <div>
                            ...
                            <input type="text" placeholder="Search for products" className="text-sm leading-none  text-gray-300  bg-gray-900 text-gray-600 focus:outline-none" />
                        </div>
                        <div className="space-x-6">
                            <button aria-label="view favourites" className="text-gray-800  text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                            ...
                            <button aria-label="go to cart" className="text-gray-800  text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                    ...
                    <div className=" bg-gray-800   px-3 py-4">
                        <div className="container mx-auto flex items-center justify-between ">
                                <img onClick={()=>{setEco("normal")}} src={log} alt="logo" className="w-10" />
                            <h1 className="md:w-2/12 cursor-pointer text-gray-800  text-white" aria-label="the Crib.">
                            ...
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8 ml-[-0200px]">
                                <li>
                                <Link 
                                to={'/'}   className=" text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">    
                                   Home
                                   </Link>
                                ...
                                <li>
                                <Link onClick={toggleEco}
                                to={'/product/All-products'}   className=" text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        Products
                                        </Link>
                                </li>
                                <li onClick={handleNav}
                               className=" text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                               Eco Products
                                        
                                </li>
                                <li>
                                <Link
                  to="/aboutus"className=" text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        About Us
                                        </Link>
                                ...
                                <li>
                                <Link
                  to="/ContactUs" className=" text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                       Contact Us
                                       </Link>
                            ...
                            <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                                <div className="hidden lg:flex items-center">
                                    {/* <button onClick={() => setSearchInput(!searchInput)} aria-label="search items" className="text-gray-800  hover:text-gray-300  text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                                ...
                                placeholder="search" className={` ${searchInput ? "hidden" : ""} text-sm  bg-white  placeholder-gray-300 text-yellow-600 rounded ml-1 border border-transparent focus:outline-none focus:border-gray-400 px-1 w-[100px]`} />
                                */}
...
<div class="flex flex-row  h-[30px]">
    <input
      ...
      class="bg-white relative m-0 -mr-0.5 block  min-w-10 flex-auto rounded-l border border-solid border-neutral-300 text-black first-letter:bg-clip-padding w-28   placeholder:text-black
    ...
    onClick={handleSearch}
      class="relative z-[2] flex items-center rounded-r bg-yellow-500 px-1.5 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-yellow-700 hover:shadow-lg focus:bg-yellow-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-800 active:shadow-lg"
      type="button"
      id="button-addon1"
      data-te-ripple-init
      ...
      <svg
        ...
        <path
          ...
          clip-rule="evenodd" />
                                ...
                                <div className=" lg:flex items-center space-x-4 xl:space-x-8">
                                    <button  onClick={toggleProfile} aria-label="go to cart" className="text-gray-800  hover:text-gray-300  text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                                      <CgProfile className="text-3xl font-thin"/>
                                    </button>
{Token!==''&&user ? 
  (
    <div
    className={`absolute right-10 z-10 top-20 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ${
    popen ? "block" : "hidden"
    }`}
    role="menu"
  ...
  >
    ...
    //not signed in
    <div
    className={`absolute right-10 z-10 top-20 w-[250px] origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ${
    popen ? "block" : "hidden"
    }`}
    role="menu"
    aria-orientation="vertical"
  ...
  >
    ...
    Login/SignUp
                            ...
                            <button aria-label="view favourites" className="text-gray-800  hover:text-gray-300  text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                           <Link to={'/cart'}><CartIcon/></Link>
                            </button>


                                    <button aria-label="go to cart" className="text-gray-800  hover:text-gray-300  text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                                ...
                                <div className="flex lg:hidden">
                                    <button aria-label="show options" onClick={() => setMdOptionsToggle(!mdOptionsToggle)} className="text-black  text-white  hover:text-gray-300 hidden md:flex focus:outline-none focus:ring-2 rounded focus:ring-gray-600">
                                        <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button aria-label="open menu" onClick={() => setShowMenu(!showMenu)} className="text-black  text-white  hover:text-gray-300 md:hidden focus:outline-none focus:ring-2 rounded focus:ring-gray-600">
                                        <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4 6H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M10 12H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M6 18H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    {/* For small screen */}
                    <div id="mobile-menu" className={`${showMenu ? "flex" : "hidden"} absolute  bg-gray-900 z-10 inset-0 md:hidden  flex-col h-[100vh] w-1/2 mt-[85px] overflow-scroll`}>
                        <div className="flex items-center justify-between border-b    border-gray-700 pb-4 p-4">
                            <div className="flex items-center space-x-3">
                                <div>
                                    <svg className="fill-stroke text-gray-800  text-white" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input type="text" placeholder="Search for products" className="text-sm  bg-gray-900 text-gray-600 placeholder-gray-600  placeholder-gray-300 focus:outline-none" />
                            </div>
                            <button onClick={() => setShowMenu(false)} aria-label="close menu" className="focus:outline-none focus:ring-2 rounded focus:ring-gray-600">
                                <svg className="fill-stroke text-gray-800  text-white" width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="mt-6 p-4 ">
                            <ul className="flex flex-col space-y-6">
                                <li>
                                    <a href="javascript:void(0)" className=" text-white flex items-center justify-between hover:underline text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800">
                                        Home
                                        <div>
                                            <svg className="fill-stroke text-black  text-white" width={12} height={12} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* <div className="h-full flex items-end"> */}
                            <ul className="flex flex-col space-y-8 bg-gray-50 w-full py-10 p-4  bg-gray-800">
                                <li>
                                    <a href="javascript:void(0)" className=" text-white text-gray-800 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        <div>
